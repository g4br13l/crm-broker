...
import { useIsMobile } from '@/shared/react/hooks/useMobile'
...
const SidebarContext = React.createContext<SidebarContextPropsT | null>(null)
...
function SidebarProvider({
  ...
  const contextValue = React.useMemo<SidebarContextPropsT>(
    () => ({
      state,
      open,
      setOpen,
